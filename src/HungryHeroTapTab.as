...
package
{
	 ...
	 */	
	[SWF(frameRate="60", width="900", height="675", backgroundColor="0x000000")]
	 ...
	 * 
	 */
	public class HungryHeroTapTab extends Sprite
	{
		/** Starling object. */
		private var myStarling:Starling;
		
		public function HungryHeroTapTab()
		{
			super();
		...
		protected function onAddedToStage(event:Event):void
		{
			...
			myStarling.viewPort = new Rectangle(0, 0, 900, 675);
